...
const AddStoreColumn = () => {
  ...
  return (
    <div onClick={handleClick} className="w-56 flex m-6 hover:bg-slate-200 cursor-pointer justify-center items-center h-40 border-2 border-dotted border-black">
